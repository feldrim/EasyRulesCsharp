namespace EasyRulesCsharp.Core {
	public class UtilsTest {
		...
		private static void AssertCorrectAnnotationIsFound(ref Class<void> expectedAnnotationType, ref Annotation actualAnnotation) {
			throw new System.Exception("Not implemented");
		}

		private sealed class AnnotationIsPresentViaMetaAnnotation {
		}
		private sealed class AnnotationIsPresent {
		}
	}
